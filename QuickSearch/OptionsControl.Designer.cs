namespace QuickSearch
{
    partial class OptionsControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.MainOptionsPanel.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
            this.MainOptionsPanel.Controls.Add(this.labelWidth, 0, 0);
            this.MainOptionsPanel.Controls.Add(this.ControlWidth, 2, 0);
            this.MainOptionsPanel.Controls.Add(this.labelBGColor, 0, 1);
            this.MainOptionsPanel.Controls.Add(this.labelBGColorSuccess, 1, 2);
            this.MainOptionsPanel.Controls.Add(this.colorSelectButtonSuccess, 2, 2);
            this.MainOptionsPanel.Controls.Add(this.labelSearchPending, 1, 3);
            this.MainOptionsPanel.Controls.Add(this.colorSelectButtonPending, 2, 3);
            this.MainOptionsPanel.Controls.Add(this.labelBGColorError, 1, 4);
            this.MainOptionsPanel.Controls.Add(this.colorSelectButtonError, 2, 4);
            this.MainOptionsPanel.Controls.Add(this.labelBGColorNormalUnFocused, 1, 5);
            this.MainOptionsPanel.Controls.Add(this.colorSelectButtonUnfocused, 2, 5);
            this.MainOptionsPanel.Controls.Add(this.labelBGColorFocused, 1, 6);
            this.MainOptionsPanel.Controls.Add(this.colorSelectButtonFocused, 2, 6);
